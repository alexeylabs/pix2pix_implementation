...
Шутка. Предпримем еще одну попытку нарисовать автомобиль:

<img src="article/doodle_006.png" /><img src="article/image_from_doodle_006.png" />

Наш генератор умеет генерировать не только автомобили:

<img src="article/doodle_007.png" /><img src="article/image_from_doodle_007.png" />
...
Кроме того, генератор вышел за границы объекта при генерации изображения из первых двух скетчей, что было неожиданным. Скорей всего, это связано с наличием в исходном датасете белых автомобилей на белом фоне, которые были не точно преобразованы в изображение краев объекта.

Как показывают последующие примеры, при достаточно детализированном наброске удается сгенерировать правдоподобные автомобили.